...
public class CooperOreBlock extends BasicModModElements.ModElement {
	@ObjectHolder("basic_mod:cooper_ore")
	public static final Block block = null;
	public CooperOreBlock(BasicModModElements instance) {
		super(instance, 2);
	}
